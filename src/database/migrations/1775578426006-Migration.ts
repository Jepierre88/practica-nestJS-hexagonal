...
export class Migration1775578426006 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "cs2"."weapons" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(150) NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_a102f55ffbab023a922ac10ab76" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "cs2"."collections" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(150) NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_21c00b1ebbd41ba1354242c5c4e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "cs2"."openings" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(150) NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_52465524569a0b0e856a64eb48b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "cs2"."skins" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(150) NOT NULL, "price" numeric(10,2) NOT NULL, "skin_float" numeric(10,8) NOT NULL, "weapon_id" uuid NOT NULL, "collection_id" uuid NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_c47cf9e147be994b18e622848c6" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "cs2"."case_skins" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "case_id" uuid NOT NULL, "skin_id" uuid NOT NULL, "drop_rate" numeric(5,2) NOT NULL, CONSTRAINT "PK_4260620e05e570d35dd288d8a3a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "cs2"."cases" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(150) NOT NULL, "price" numeric(10,2) NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_264acb3048c240fb89aa34626db" PRIMARY KEY ("id"))`);
        await queryRunner.query(`ALTER TABLE "auth"."users" ADD CONSTRAINT "FK_b6bb02f6cd87c7ae80f1bbb9339" FOREIGN KEY ("subscription_id") REFERENCES "enterprise"."subscriptions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "cs2"."skins" ADD CONSTRAINT "FK_35b23d32ed7212aa41c646b8ede" FOREIGN KEY ("weapon_id") REFERENCES "cs2"."weapons"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "cs2"."skins" ADD CONSTRAINT "FK_9125ec6d5c991705e61175dc21b" FOREIGN KEY ("collection_id") REFERENCES "cs2"."collections"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "cs2"."case_skins" ADD CONSTRAINT "FK_dc22ac77e1778a26a0a6aa775db" FOREIGN KEY ("case_id") REFERENCES "cs2"."cases"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "cs2"."case_skins" ADD CONSTRAINT "FK_5bc16cf3a13e77a44e73a0f7e9f" FOREIGN KEY ("skin_id") REFERENCES "cs2"."skins"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "cs2"."case_skins" DROP CONSTRAINT "FK_5bc16cf3a13e77a44e73a0f7e9f"`);
        await queryRunner.query(`ALTER TABLE "cs2"."case_skins" DROP CONSTRAINT "FK_dc22ac77e1778a26a0a6aa775db"`);
        await queryRunner.query(`ALTER TABLE "cs2"."skins" DROP CONSTRAINT "FK_9125ec6d5c991705e61175dc21b"`);
        await queryRunner.query(`ALTER TABLE "cs2"."skins" DROP CONSTRAINT "FK_35b23d32ed7212aa41c646b8ede"`);
        await queryRunner.query(`ALTER TABLE "auth"."credentials" DROP CONSTRAINT "FK_c68a6c53e95a7dc357f4ebce8f0"`);
        await queryRunner.query(`ALTER TABLE "auth"."users" DROP CONSTRAINT "FK_b6bb02f6cd87c7ae80f1bbb9339"`);
